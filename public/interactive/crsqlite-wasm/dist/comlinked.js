...
var sqlite3InitModule$1 = (() => {
    ...
    return (function (sqlite3InitModule) {
        ...
        */
        const xNameOfInstantiateWasm = 'instantiateWasm'
            ;
        Module[xNameOfInstantiateWasm] = function callee(imports, onSuccess) {
            imports.env.foo = function () { };
            const uri = Module.locateFile(callee.uri, (('undefined' === typeof scriptDirectory /*var defined by Emscripten glue*/)
                ? "" : scriptDirectory));
        ...
        */
        ...
        function updateGlobalBufferAndViews(buf) {
            ...
            Module['HEAP64'] = new BigInt64Array(buf);
            Module['HEAPU64'] = new BigUint64Array(buf);
        }
        ...
        /** @type {function(...*):?} */
        Module["_sqlite3_wasm_ptr_to_sqlite3_free"] = function () {
            return (Module["_sqlite3_wasm_ptr_to_sqlite3_free"] = Module["asm"]["sqlite3_wasm_ptr_to_sqlite3_free"]).apply(null, arguments);
        };
        /** @type {function(...*):?} */
        ...
        */
        ...
        Module.postRun.push(function (Module /*the Emscripten-style module object*/) {
            self.sqlite3ApiBootstrap = function sqlite3ApiBootstrap(apiConfig = (self.sqlite3ApiConfig || sqlite3ApiBootstrap.defaultConfig)) {
                ...
                */
                ...
                Object.assign(capi, {
                    ...
                    */
                    sqlite3_prepare_v3: (dbPtr, sql, sqlByteLen, prepFlags, stmtPtrPtr, strPtrPtr) => { } /*installed later*/,
                    /**
                ...
                */
                capi.sqlite3_js_aggregate_context = (pCtx, n) => {
                    return capi.sqlite3_aggregate_context(pCtx, n)
                        || (n ? WasmAllocError.toss("Cannot allocate", n, "bytes for sqlite3_aggregate_context()")
                            : 0);
                };
                /**
                ...
                */
                capi.sqlite3changeset_new_js =
                    (pChangesetIter, iCol) => __newOldValue(pChangesetIter, iCol, 'sqlite3changeset_new');
                /**
                   The sqlite3changeset_old() counterpart of
                   sqlite3changeset_new_js(), with an identical interface.
                */
                capi.sqlite3changeset_old_js =
                    (pChangesetIter, iCol) => __newOldValue(pChangesetIter, iCol, 'sqlite3changeset_old');
            ...
            self.WhWasmUtilInstaller = function (target) {
                ...
                */
                target.jsFuncToWasm = function f(func, sig) {
                    ...
                    wasmCode.unshift(0x00, 0x61, 0x73, 0x6d, /* magic: "\0asm" */ 0x01, 0x00, 0x00, 0x00, /* version: 1 */ 0x01 /* type section code */);
                    wasmCode.push(
                ...
                */
                target.allocCString =
                    (jstr, returnWithLength = false) => __allocCStr(jstr, returnWithLength, target.alloc, 'allocCString()');
                /**
                ...
                */
                target.scopedAllocCString =
                    (jstr, returnWithLength = false) => __allocCStr(jstr, returnWithLength, target.scopedAlloc, 'scopedAllocCString()');
            ...
            self.Jaccwabyt = function StructBinderFactory(config) {
                ...
                */
                ...
                const heap = (config.heap instanceof Function)
                    ? config.heap : (() => new Uint8Array(config.heap.buffer)), alloc = config.alloc, dealloc = config.dealloc, log = config.log || console.log.bind(console), memberPrefix = (config.memberPrefix || ""), memberSuffix = (config.memberSuffix || ""), bigIntEnabled = (undefined === config.bigIntEnabled
                    ? !!self['BigInt64Array'] : !!config.bigIntEnabled), BigInt = self['BigInt'], BigInt64Array = self['BigInt64Array'], 
                /* Undocumented (on purpose) config options: */
                ptrSizeof = config.ptrSizeof || 4, ptrIR = config.ptrIR || 'i32';
                if (!SBF.debugFlags) {
            ...
            */
            self.sqlite3ApiBootstrap.initializers.push(function (sqlite3) {
                ...
                */
                ...
                { // wasm.xWrap() bindings...
                    ...
                    */
                    ...
                    wasm.xWrap.argAdapter('sqlite3_filename', __xArgPtr)('sqlite3_context*', __xArgPtr)('sqlite3_value*', __xArgPtr)('void*', __xArgPtr)('sqlite3_changegroup*', __xArgPtr)('sqlite3_changeset_iter*', __xArgPtr)('sqlite3_session*', __xArgPtr)('sqlite3_stmt*', (v) => __xArgPtr((v instanceof (sqlite3?.oo1?.Stmt || nilType))
                        ? v.pointer : v))('sqlite3*', (v) => __xArgPtr((v instanceof (sqlite3?.oo1?.DB || nilType))
                        ? v.pointer : v))('sqlite3_index_info*', (v) => __xArgPtr((v instanceof (capi.sqlite3_index_info || nilType))
                        ? v.pointer : v))('sqlite3_module*', (v) => __xArgPtr((v instanceof (capi.sqlite3_module || nilType))
                        ? v.pointer : v))('sqlite3_vfs*', (v) => {
                        if ('string' === typeof v) {
                    ...
                    */
                    ...
                    if (capi.sqlite3_index_info) {
                        ...
                        ** passed them to StructBinder. */
                        ...
                        capi.sqlite3_vtab_config = wasm.xWrap('sqlite3_wasm_vtab_config', 'int', [
                            'sqlite3*', 'int', 'int'
                        ]);
                ...
                */
                const __dbArgcMismatch = (pDb, f, n) => {
                    return sqlite3.util.sqlite3_wasm_db_error(pDb, capi.SQLITE_MISUSE, f + "() requires " + n + " argument" +
                        (1 === n ? "" : 's') + ".");
                };
                ...
                */
                ...
                const __dbCleanupMap = function (pDb, mode /*0=remove, >0=create if needed, <0=do not create if missing*/) {
                    pDb = __argPDb(pDb);
                ...
                */
                ...
                { /* Special-case handling of sqlite3_create_function_v2()
                    ...
                    */
                    ...
                    capi.sqlite3_create_function_v2 = function f(pDb, funcName, nArg, eTextRep, pApp, xFunc, //void (*xFunc)(sqlite3_context*,int,sqlite3_value**)
                    ...
                    /* Documented in the api object's initializer. */
                    capi.sqlite3_create_window_function = function f(pDb, funcName, nArg, eTextRep, pApp, xStep, //void (*xStep)(sqlite3_context*,int,sqlite3_value**)
                    xFinal, //void (*xFinal)(sqlite3_context*)
                    ...
                    */
                    const __prepare = {
                        /**
                           ...
                           below) must be used.
                        */
                        basic: wasm.xWrap('sqlite3_prepare_v3', "int", ["sqlite3*", "string",
                        ...
                        */
                        ...
                        for (const k of Object.keys(kvvfsImpls)) {
                            kvvfsMethods[kvvfsMethods.memberKey(k)] =
                                wasm.installFunction(kvvfsMethods.memberSignature(k), kvvfsImpls[k]);
                        }
                    }
                    else {
            ...
            self.sqlite3ApiBootstrap.initializers.push(function (sqlite3) {
                sqlite3.version = { "libVersion": "3.41.0", "libVersionNumber": 3041000, "sourceId": "2023-01-03 15:11:01 df5ea47130d275e9fa1bd6aa8d55f1d5e136cba30ba13b7ede22224aa7f7alt1", "downloadVersion": 3410000 };
            });
                ...
                const checkSqlite3Rc = function (dbPtr, sqliteResultCode) {
                    if (sqliteResultCode) {
                        if (dbPtr instanceof DB)
                            dbPtr = dbPtr.pointer;
                        toss3("sqlite3 result code", sqliteResultCode + ":", (dbPtr
                ...
                DB.prototype = {
                    ...
                    */
                    exec: function ( /*(sql [,obj]) || (obj)*/) {
                        ...
                        let stmt;
                        let bind = opt.bind;
                        let evalFirstResult = !!(arg.cbArg || opt.columnNames || resultRows) /* true to step through the first result-returning statement */;
                    ...
                    */
                    bind: function ( /*[ndx,] arg*/) {
                        ...
                        if ('object' === typeof arg /*null was checked above*/
                            ...
                            Object.keys(arg)
                                .forEach(k => bindOne(this, k, affirmSupportedBindType(arg[k]), arg[k]));
                            return this;
                        }
                        else {
            ...
            */
            ...
            self.sqlite3ApiBootstrap.initializers.push(function (sqlite3) {
                        ...
                        callee.argcProxy = function (tgt, funcName, func, sig) {
                            return function (...args) {
                                if (func.length !== arguments.length) {
                                    toss("Argument mismatch for", tgt.structInfo.name + "::" + funcName
                ...
                */
                sqlite3.StructBinder.StructType.prototype.installMethod = function callee(name, func, applyArgcCheck = installMethod.installMethodArgcCheck) {
                ...
                /**
                   ...
                   of this object.
                */
                sqlite3.StructBinder.StructType.prototype.installMethods = function (methods, applyArgcCheck = installMethod.installMethodArgcCheck) {
                ...
                vtab.setupModule = function (opt) {
                    ...
                    try {
                        ...
                        if (opt.catchExceptions) {
                            ...
                            // to not throw.
                            installMethods(mod, methods, !!opt.applyArgcCheck /*undocumented option*/);
                        }
                        if (0 === mod.$iVersion) {
                            let v;
                ...
                */
                const installOpfsVfs = function callee(options) {
                    ...
                    const thePromise = new Promise(function (promiseResolve, promiseReject_) {
                        ...
                        */
                        opfsUtil.metrics = {
                            dump: function () {
                                ...
                                console.log(self.location.href, "metrics for", self.location.href, ":", metrics, "\nTotal of", n, "op(s) for", t, "ms (incl. " + w + " ms of waiting on the async side)");
                        ...
                        */
                        state.sabIO = new SharedArrayBuffer(state.fileBufferSize /* file i/o block */
                        ...
                        const metrics = Object.create(null);
                        {
                            ...
                            state.opIds.retry = i++;
                            state.sabOP = new SharedArrayBuffer(i * 4 /* ==sizeof int32, noting that Atomics.wait() and friends
            ...
            if ('undefined' !== typeof Module) { // presumably an Emscripten build
                ...
                */
                ...
                console.warn("This is not running in an Emscripten module context, so", "self.sqlite3ApiBootstrap() is _not_ being called due to lack", "of config info for the WASM environment.", "It must be called manually.");
            }
...
if (typeof exports === 'object' && typeof module === 'object')
    module.exports = sqlite3InitModule$1;
else if (typeof define === 'function' && define['amd'])
    define([], function () { return sqlite3InitModule$1; });
else if (typeof exports === 'object')
    exports["sqlite3InitModule"] = sqlite3InitModule$1;
...
(function () {
    ...
    */
    ...
    /* Maintenance reminder: DO NOT use `self.` here. It's correct
       ...
       resolve this symbol differently. */ sqlite3InitModule$1;
    if (!originalInit) {
...
class SQLite3 {
    baseSqlite3;
    constructor(baseSqlite3) {
        this.baseSqlite3 = baseSqlite3;
    }
    /**
     *
    ...
    open(filename, mode = "c") {
        if (filename == null || filename === ":memory:") {
            ...
            return new DB(new this.baseSqlite3.oo1.DB(filename, mode, "opfs"), this.baseSqlite3);
        }
    }
}
class DB {
    ...
    onUpdate(cb) {
        if (this.#updateHooks == null) {
            this.sqlite3.capi.sqlite3_update_hook(this.baseDb.pointer, this.#onUpdate, 0);
            this.#updateHooks = new Set();
        }
        this.#updateHooks.add(cb);
        return () => this.#updateHooks?.delete(cb);
    }
    #onUpdate = (usrData, type, dbName, tblName, rowid) => {
        if (this.#updateHooks == null) {
            return;
        }
    ...
    createFunction(name, fn, opts) {
        ...
        this.baseDb.createFunction(name, (ctx, ...args) => fn(...args), {
            arity: fn.length,
            ...opts,
        });
    }
...
function initWasm(locators) {
    // @ts-ignore
    return sqlite3InitModule(locators).then((baseSqlite3) => {
...
const extensionTearDowns = new Map();
const api = {
    onReady(urls, cb, err) {
        if (promise == null) {
            promise = initWasm({
    ...
    open(file, mode = "c") {
        if (promise == null) {
            throw new Error("You must await initialization by calling `onReady` first");
        }

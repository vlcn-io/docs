...
Vulcan is [a database extension](./cr-sqlite/intro) and [set of integrations](./js/wasm) to allow you to create these kinds of applications without being a distributed systems expert.

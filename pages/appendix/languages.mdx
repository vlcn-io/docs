...
In the intro we mentioned that Vulcan is composed of `cr-sqlite` and then additional components built around it to provide a complete exerpience for developing applications which rely on distributed state.

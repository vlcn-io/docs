...
While `cr-sqlite` can run anywhere and provide you with a database that supports merging over a SQL API, platform & language integrations exist to simplify things and provide a more complete experience.

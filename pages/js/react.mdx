...
<Callout type="info">
To get started with React quickly, scaffold a new project with `npm create @vlcn.io your-app-name`.
</Callout>
...
2. A `DBProvider` to provide one or more databases to your component tree and kick off sync.

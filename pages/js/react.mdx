...
<RunnableCode code={`const initWasm = await import('https://esm.sh/@vlcn.io/crsqlite-wasm@0.10.0-next.1');
const sqlite = await initWasm.default(
  () => "https://esm.sh/@vlcn.io/crsqlite-wasm@0.10.0-next.1/dist/crsqlite.wasm"
);
...
const [vlcnReact, React, htm] = await Promise.all([
  import("https://esm.sh/@vlcn.io/react@0.10.0-next.1"),
...
const [React, reactDom, htm, tblrx] = await Promise.all([
  ...
  import("https://esm.sh/htm@3.1.1/react"),
  import("https://esm.sh/@vlcn.io/rx-tbl@0.9.0-next.1"),
]);

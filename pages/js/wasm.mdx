...
> Each of the [cr-sqlite guides](/js/merging-databases) leverages the WASM build to provide working examples in the browser.
...
- [Persistence](/jd/persistence)
- [Browser tab sync](/js/browser-tabs)

...
The API for interacting with the database will be the same as whatever `sqlite` bindings you chose. Creating conflict free tables and merging databases is done entirely over SQL. See the `cr-sqlite` [API documentation](/cr-sqlite/api-methods) & [guides](/cr-sqlite/guides/merging-databases).

...
Vulcan is [a database extension](/docs/cr-sqlite/intro) and [set of platform SDKs](/docs/js/wasm) to allow you to create these kinds of applications without being a distributed systems expert.

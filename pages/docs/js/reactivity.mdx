...
<RunnableCode code={`const initWasm = await import('https://esm.sh/@vlcn.io/crsqlite-wasm@0.15.1');
const sqlite = await initWasm.default(
  () => "https://esm.sh/@vlcn.io/crsqlite-wasm@0.15.1/dist/crsqlite.wasm"
);
...
<RunnableCode
  code={`use db;
const tblrx = await import('https://esm.sh/@vlcn.io/rx-tbl@0.14.1');

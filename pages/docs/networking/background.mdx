...
Only changes made to [CRRs](/appendix/crr) are returned by [crsql_changes](/docs/cr-sqlite/api-methods/crsql_changes). This allows you to have data which should be completely local (regular tables) and data which is intended to be synced with other databases (CRRs).

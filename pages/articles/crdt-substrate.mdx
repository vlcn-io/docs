...
And then let you author _any mutation you want_ against that state. The only rule is that your mutations must be deterministic. Two example mutations have been provided for you below.
...
Now lets see your state and mutations in action.
